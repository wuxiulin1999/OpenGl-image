...
public class Human4 {
	...
	public void DrawHuman(float delta,boolean GoodAnimation,boolean LegAnimation,ArrayList<Texture> texturelist) 
	 { //input a texture list ,so that the object in the class can use textures
			 float theta = (float) (delta * 25 * Math.PI);
			  ...
			  if(LegAnimation) {
				  LegRotation=(float)Math.cos(theta)*45;
			  }else {
				  LegRotation=0;
			  }
					                            ...
					                            GL11.glColor3f(black[0], black[1], black[2]);
						                           GL11.glMaterial( GL11.GL_FRONT, GL11.GL_AMBIENT_AND_DIFFUSE,  Utils.ConvertForGL(orange));
						                            GL11.glPushMatrix(); {
						                                GL11.glTranslatef(0.0f,0.0f,0.0f);
						                                if(LimbRotation<0) {
						                                	 GL11.glRotatef(LimbRotation/4,0.0f,1.0f,0.0f);
						                                }
						                                ...
						                                GL11.glColor3f(red[0], red[1], red[2]);
							                               GL11.glMaterial( GL11.GL_FRONT, GL11.GL_AMBIENT_AND_DIFFUSE,  Utils.ConvertForGL(blue));
							                                GL11.glPushMatrix(); {
							                                    ...
							                                    champion.drawChampion(texturelist.get(2));
			            ...
			            GL11.glPushMatrix(); {
			               ...
			               GL11.glMaterial( GL11.GL_FRONT, GL11.GL_AMBIENT_AND_DIFFUSE,  Utils.ConvertForGL(orange));
			                GL11.glPushMatrix(); {
			                    ...
			                    GL11.glRotatef((LegRotation/2),1.0f,0.0f,0.0f); 
